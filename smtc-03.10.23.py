...
TEXT_BEFORE_SEND_EDIT = "Если всё ОК, жмём ОПУБЛИКОВАТЬ, если описание необходимо исправить, жмём РЕДАКТИРОВАТЬ"
TEXT_BEFORE_EDIT = "Напишите описание заново"
TEXT_AFTER_PUBLICATION = "Объявление опубликовано. Для того, чтобы добавть новое объявление, напишите /start"
TEXT_IF_TOO_LONG = "Теткст должен быть короче 250 символов. Пожалуйста, введите текст заново."
